...
export const WEEKLY_RECAP_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px;">
                            <h1 style="margin: 0 0 8px 0; font-size: 24px; font-weight: 600; color: #FDD458; line-height: 1.2;">
                                Your Weekly Recap
                            </h1>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC;">
                                    Generated by AI from your portfolio + watchlist activity. Not investment advice.
                                </p>
...
export const SENTIMENT_ALERT_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Sentiment Alert: {{symbol}}</title>
</head>
<body style="margin: 0; padding: 0; background-color: #050505; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #050505;">
        <tr>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td style="padding: 0 40px 20px 40px;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: {{headerBg}}; border-radius: 8px; padding: 20px;">
                                <tr>
                                    <td align="center">
                                        <h1 style="margin: 0 0 10px 0; font-size: 24px; font-weight: 700; color: #ffffff; line-height: 1.2;">
                                            {{headerEmoji}} News Sentiment {{directionVerb}}
                                        </h1>
                                        <p style="margin: 0; font-size: 16px; color: #ffffff; opacity: 0.9;">
                                            {{timestamp}}
                                        </p>
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px;">
                            <div style="text-align: center; padding: 30px 20px; background-color: #212328; border-radius: 8px; margin-bottom: 20px;">
                                <h2 style="margin: 0 0 10px 0; font-size: 28px; font-weight: 700; color: #ffffff;">{{symbol}}</h2>
                                <p style="margin: 0 0 20px 0; font-size: 16px; color: #6b7280;">{{company}}</p>
                                <div>
                                    <p style="margin: 0 0 5px 0; font-size: 14px; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px;">
                                        Avg Sentiment ({{windowDays}}d)
                                    </p>
                                    <p style="margin: 0; font-size: 36px; font-weight: 700; color: {{sentimentColor}};">
                                        {{currentSentiment}}
                                    </p>
                                    <p style="margin: 8px 0 0 0; font-size: 14px; color: #9ca3af;">
                                        based on {{articleCount}} article(s)
                                    </p>
                                </div>
                            </div>
                            <div style="background-color: #212328; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                <h3 style="margin: 0 0 15px 0; font-size: 18px; font-weight: 600; color: #ffffff;">Alert Details</h3>
                                <p style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>Threshold:</strong> {{threshold}}
                                </p>
                                <p style="margin: 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>Trigger:</strong> {{triggerDescription}}
                                </p>
                            </div>
                            <div style="background-color: #050505; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                <h3 style="margin: 0 0 8px 0; font-size: 18px; font-weight: 600; color: #E8BA40;">What this means</h3>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #ccdadc;">
                                    News coverage of {{symbol}} has shifted. AI scoring of recent headlines indicates a notable change in tone — worth a quick read of the underlying articles before reacting.
                                </p>
                            </div>
                            <p style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC; text-align: center;">
                                © 2025 Signalist
                            </p>
                        </td>
                    </tr>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td style="padding: 20px 40px 40px 40px;">
                            <h1 style="margin: 0 0 20px 0; font-size: 24px; font-weight: 600; color: #FDD458; line-height: 1.2;">
                                Reset your password
                            </h1>
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                Hi {{name}}, we received a request to reset the password on your Signalist account.
                                Click the button below to choose a new one.
                            </p>
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 30px 0; width: 100%;">
                                <tr>
                                    <td align="center">
                                        <a href="{{resetUrl}}" style="display: block; width: 100%; background: linear-gradient(135deg, #FDD458 0%, #E8BA40 100%); color: #000000; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1; text-align: center; box-sizing: border-box;">
                                            Reset Password
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin: 0 0 12px 0; font-size: 14px; line-height: 1.6; color: #9ca3af;">
                                The link will expire in 1 hour. If the button above doesn't work, copy and paste this URL into your browser:
                            </p>
                            <p style="margin: 0 0 30px 0; font-size: 13px; line-height: 1.5; color: #FDD458; word-break: break-all;">
                                {{resetUrl}}
                            </p>
